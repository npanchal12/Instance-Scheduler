...
module "scheduler" {
  ...
  lambda_function_start_stop_ec2_arn  = module.lambda_function.lambda_function_start_stop_ec2_arn
  lambda_function_start_stop_ec2_name = module.lambda_function.lambda_function_start_stop_ec2_name
}
